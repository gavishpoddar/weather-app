...
const Home: React.FC = () => {
  ...
  const dateFormatOptions = new Intl.DateTimeFormat('en-us', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' });
    ...
    navigator.geolocation.getCurrentPosition(
      async position => {
        ...
        const currentWeather = {
          ...
          options: [
            { description: 'Temperature', value: parseInt(data.main.feels_like), metric: 'ºC' },
            { description: 'Sunrise', value: convertUnixToHours({ unixTime: data.sys.sunrise, unixTimezone: data.timezone }), metric: '' },
            { description: 'Sunset', value: convertUnixToHours({ unixTime: data.sys.sunset, unixTimezone: data.timezone }), metric: '' },
            { description: 'Moisture', value: data.main.humidity, metric: '%' },
            { description: 'Visibility', value: convertMetersToQuilometers(data.visibility), metric: 'km' },
            { description: 'Pressure', value: data.main.pressure, metric: 'hPa' },
          ]
        };
